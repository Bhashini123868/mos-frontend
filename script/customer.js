loadTable();
function loadTable() {
  fetch("http://localhost:8085/mos/customer/get-all")
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
...
function addCustomer() {
  ...
  if (validePhoneNumber(CusPhoneNumber)) {
    ...
    fetch("http://localhost:8085/mos/customer/add", requestOptions)
...
function deleteCustomer(index) {
  ...
  fetch(`http://localhost:8085/mos/customer/delete/${index}`, requestOptions)
    .then((response) => {
      if (!response.ok) {
...
function EditCustomer(index) {
  ...
  fetch(`http://localhost:8085/mos/customer/search-by-id/${index}`, requestOptions)
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
...
function updateCustomer(index) {
  ...
  fetch(`http://localhost:8085/mos/customer/update/${index}`, requestOptions)
    .then((response) => response.text())
    .then((result) => {
      console.log(result);
      document.getElementById("Name").value = "";
